      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="block md:hidden space-y-4">
          {products?.map((product) => (
            <div
              key={product._id}
              className="bg-zinc-900/50 border border-zinc-800 p-5 rounded-sm"
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-blue-400 font-mono text-[10px] mt-1">
                    {product._id}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs uppercase font-bold tracking-widest text-zinc-500 mb-6">
                <div>
                  <span className="block text-[10px] text-zinc-600 mb-1">
                    Category
                  </span>
