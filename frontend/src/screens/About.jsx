    ...
    <div className="bg-black text-white min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="z-10">
            ...
            <div className="space-y-6 text-zinc-400 text-lg md:text-xl leading-relaxed font-medium max-w-xl">
              <p>
                EVANOX was founded to bridge the gap between high-end design and
                raw technical performance. We don't just sell templates; we
                provide the architectural blueprints for the modern web.
              </p>
              <p className="border-t border-zinc-800 pt-6">
                From high-conversion React layouts to secure hosting protocols
                and deep-level software analysis, we empower developers and
                brands to dominate their digital landscape.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-zinc-400 text-xl font-medium">
                Engineered for speed. Secured for scale. We provide the
                foundational layers required for professional digital
                excellence.
              </p>
            </div>
      ...
      <section className="py-40 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-[0.02] select-none pointer-events-none">
          <h2 className="text-[25vw] font-black uppercase leading-none">
            ROOT
          </h2>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-zinc-400 text-xl mb-12 max-w-2xl mx-auto font-medium">
            Join the network of high-performance developers and businesses
            leveraging EVANOX infrastructure.
          </p>
